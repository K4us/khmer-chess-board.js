...
export default class BoardManager {
    ...
    flip(): void;
    readonly pieceCells: CellManager[];
    readonly pieceInTurnCells: CellManager[];
    ...
    readonly turnCells: CellManager[];
    ...
    addOnChangeTurnEventListener(listener: ListenerType<any>): void;
    removeOnChangeTurnEventListener(listener: ListenerType<any>): void;
}
